<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EncryptServer.aspx.cs" Inherits="EncryptServer" %>
                            ...
                            <tr>
                                <td style="text-align: left">
                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                                        PostBackUrl="~/Fileupload.aspx" Width="77px">File Upload</asp:LinkButton>
                                </td>
                                <td class="style22">
                                    &nbsp;</td>
                                <td class="style22">
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="565px" BorderStyle="Ridge">
                        <table class="style6">
                            ...
                            <tr>
                                ...
                                <td class="style12">
                                    <asp:TextBox ID="TextBox1" runat="server" BackColor="#CCFFFF" 
                                        ...
                                        Height="101px" Width="262px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                                <td class="style43">
                                ...
                                <td>
                                    <asp:Button ID="Button3" runat="server" BackColor="#009900" 
                                        ...
                                        Height="32px" onclick="Button3_Click" Text="Encrypt Server 1" Width="116px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style34">
                            ...
                            <tr>
                                ...
                                <td class="style19">
                                    <asp:TextBox ID="TextBox2" runat="server" BackColor="#CCFFFF" 
                                        BorderColor="#0066FF" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" 
                                        Height="101px" TextMode="MultiLine" Width="262px"></asp:TextBox>
                                </td>
                                <td class="style45">
                                ...
                                <td class="style16">
                                    <asp:Button ID="Button4" runat="server" BackColor="#009900" 
                                        BorderColor="#FFFF99" BorderStyle="Double" Font-Bold="True" ForeColor="Yellow" 
                                        Height="32px" onclick="Button4_Click" Text="Encrypt Server 2" Width="116px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style36">
                            ...
                            <tr>
                                ...
                                <td class="style27">
                                    <asp:Button ID="Button5" runat="server" BackColor="#009900" 
                                        BorderColor="#FFFF99" BorderStyle="Double" Font-Bold="True" ForeColor="Yellow" 
                                        Height="32px" onclick="Button5_Click" Text="Encrypt Server 3" Width="116px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style33">
                            ...
                            <tr>
                                ...
                                <td class="style12">
                                    <asp:Button ID="Button1" runat="server" BackColor="#009900" 
                                        BorderColor="#FFFF99" BorderStyle="Double" Font-Bold="True" ForeColor="Yellow" 
                                        Height="32px" onclick="Button1_Click" Text="Submit" Width="82px" />
                                </td>
                                <td class="style43">
                                    &nbsp;</td>
                                <td>
