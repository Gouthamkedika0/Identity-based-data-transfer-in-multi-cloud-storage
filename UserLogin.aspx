                ...
                <tr>
                    ...
                    <td class="style15">
                                    <asp:Label ID="Label17" runat="server" Font-Bold="True" 
                                        Font-Size="Large" ForeColor="#FF6600">User Login !</asp:Label>
                                </td>
                    <td>
                        &nbsp;</td>
                </tr>
                        ...
                        <table class="style6">
                            ...
                            <tr>
                                ...
                                <td class="style7">
                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                                        Font-Bold="True" ForeColor="#99FF66" PostBackUrl="~/UserRegister.aspx">New User ? Register Here</asp:LinkButton>
                                </td>
                                <td class="style10">
                                    &nbsp;</td>
                                <td class="style12">
                            ...
                            <tr>
                                ...
                                <td class="style10">
                                    &nbsp;</td>
                                <td class="style12">
                                    <asp:Label ID="Label16" runat="server" Font-Bold="True" ForeColor="#FFFFCC"></asp:Label>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
