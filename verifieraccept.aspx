<%@ Page Language="C#" AutoEventWireup="true" CodeFile="verifieraccept.aspx.cs" Inherits="verifieraccept" %>
                ...
                <tr>
                    ...
                    <td class="style20">
                                    <asp:Label ID="Label17" runat="server" Font-Bold="True" 
                                        Font-Size="Large" ForeColor="#FF6600">File Verify !</asp:Label>
                                </td>
                    <td>
                        &nbsp;</td>
                </tr>
                                ...
                                <td class="style22">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:ButtonField ButtonType="Button" CommandName="Select" HeaderText="Verify" 
                                                ShowHeader="True" Text="Verify" />
                                        </Columns>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="SELECT [FileID], [Filename], [FileVerify] FROM [splitbl] WHERE (([Server1Status] = @Server1Status) AND ([Server2Status] = @Server2Status) AND ([Server3Status] = @Server3Status))">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="Accepted" Name="Server1Status" Type="String" />
                                            <asp:Parameter DefaultValue="Accepted" Name="Server2Status" Type="String" />
                                            <asp:Parameter DefaultValue="Accepted" Name="Server3Status" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </td>
                                <td class="style24">
