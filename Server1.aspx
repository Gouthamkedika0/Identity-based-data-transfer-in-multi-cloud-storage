                                ...
                                <td class="style22">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Server1Status" HeaderText="Server1 Status" 
                                                SortExpression="Server1Status" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="SELECT [FileID], [Filename], [Server1Status] FROM [splitbl]">
                                    </asp:SqlDataSource>
                                </td>
                                <td class="style24">
                                </td>
