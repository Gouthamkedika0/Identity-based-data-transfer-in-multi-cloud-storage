<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerifierLogin.aspx.cs" Inherits="VerifierLogin" %>
...
<div id="templatemo_container">
    ...
    <div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="VerifierLogin.aspx" class="current">Verifier</a></li>
                ...
                <tr>
                    ...
                    <td class="style20">
                                    <asp:Label ID="Label17" runat="server" Font-Bold="True" 
                                        Font-Size="Large" ForeColor="#FF6600">Verifier Login !</asp:Label>
                                </td>
                    <td>
                        &nbsp;</td>
                </tr>
