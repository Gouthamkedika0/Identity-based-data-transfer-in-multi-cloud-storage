<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Server3.aspx.cs" Inherits="Server3" %>
                                ...
                                <td class="style22">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Server3Status" HeaderText="Server3Status" 
                                                SortExpression="Server3Status" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="SELECT [FileID], [Filename], [Server3Status] FROM [splitbl]">
                                    </asp:SqlDataSource>
                                </td>
                                <td class="style24">
                                </td>
